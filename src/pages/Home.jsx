    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-red-600 text-white py-4">
        <div className="max-w-6xl mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex gap-x-6">
            <Link to={'/auth'} className="text-white hover:text-red-200 font-bold">
              Login
            </Link>
            <Link
              to={"/register"}
              className="bg-white text-red-600 px-4 py-2 rounded-lg font-semibold hover:bg-red-100"
            >
              Signup
            </Link>
          </div>
      ...
      <section className="py-16 bg-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-3xl font-bold text-red-600 mb-6">Manage Your Tasks Effortlessly</h1>
